...
//
//%hook _TtC5Music28ContextActionsViewController
//
...
//@interface _TtC5Music37CompositeCollectionViewAwareTableCell : UIView
//
//@end
//
//%hook _TtC5Music37CompositeCollectionViewAwareTableCell
//
...
//	
//	NSLog(@"ip %@", [self valueForKey:@"lastAppliedIndexPath"]);
//	NSLog(@"ip %@", [self valueForKey:@"_lastAppliedIndexPath"]);
//    
//    
//    
//    
